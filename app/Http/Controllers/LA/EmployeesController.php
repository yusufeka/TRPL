...
class EmployeesController extends Controller
{
	...
	public $listing_cols = ['id', 'name', 'designation', 'gender', 'mobile', 'mobile2', 'email', 'dept', 'city', 'address', 'about', 'date_birth', 'date_hire', 'date_left', 'salary_cur', 'id_toko', 'id_jabatan'];
