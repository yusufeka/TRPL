...
<head>
    ...
    <meta name="author" content="Kentus Solutions">
...
<div id="features">
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-7">
				<h3 class="feature-title">What is mebelku ?</h3><br>
				<ol class="features">
				...
				<h3 class="feature-title">mebelku.com ?</h3><br>
                <ol class="features">
...
<div id="footerwrap">
    <div class="container">
        <div class="col-lg-5">
			...
			<div class="contact-link"><i class="fa fa-envelope-o"></i> <a href="">hello@mebelku.com</a></div>
			<div class="contact-link"><i class="fa fa-cube"></i> <a href="">mebelku.com</a></div>
			<div class="contact-link"><i class="fa fa-building"></i> <a href="">kentussolutions.com</a></div>
        </div>
...
<div id="c">
    <div class="container">
        <p>
            <strong>Copyright &copy; 2017. Powered by <a href=""><b>Ketus Soution</b></a>
        </p>
    </div>
</div>
